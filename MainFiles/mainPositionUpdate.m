...
if outParams.printNeighbors
    printNeighborsToFile(timeManagement.timeNow,positionManagement,outputValues.Nvehicles,NneighborsRawLTE/length(stationManagement.activeIDsLTE),NneighborsRaw11p/length(stationManagement.activeIDs11p),outParams,phyParams);
end
