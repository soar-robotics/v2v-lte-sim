...
for iV = 1:Nscheduled
    ...
    powerThreshold = simParams.powerThresholdMode4 * 12;
    ...
    while powerThreshold < 100
        ...
        usableBRs = (sensingMatrixPerm<powerThreshold) | ((sensingMatrixPerm<inf) & (knownUsedMatrixPerm<1));
